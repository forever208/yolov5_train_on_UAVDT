...
The latest version is [YOLOv5 (6.0)](https://github.com/ultralytics/yolov5/releases/tag/v6.0), you can easily upgrade to 6.0 by replacing the whole folder `models/` and `scrips/`
